...
public class ValidationDonneeConnexion extends ValidationDonnee
{
    ...
    public void validerDonnneeConnexion(String adressecourrielle, String motdepasse) throws ChampVideException {
