...
<html lang="en">
    <head>
        ...
        <title>ULavalTimeSheet - Créer un projet</title>
    <body>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-primary">
                    ...
                    <form:form id="creerProjetForm" commandName="creerProjetForm" method="POST" role="form" action="creerNouveauProjet">
                    ...
                    <button id="creerProjet-btn" type="submit" class="btn btn-primary">Créer le projet</button>
                    </div>
                    </div>
                </div>
            </div>
