...
<html lang="en">
    <head>
        ...
        <title>ULavalTimeSheet - Créer une tâche</title>
    <body>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Créer une tâche</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-primary">
                    ...
                    <form:form name="creerTacheForm" id="creer-tache-form" commandName="creerTacheForm" method="POST" role="form" action="creerNouvelleTache">
                    ...
                    <button id="creer-tache-btn" type="sumbit" class="btn btn-primary">Créer la tâche</button>
                    </div>
                    </div>
                </div>
            </div>
